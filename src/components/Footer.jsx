...
export default function Footer() {
  return (
    <footer className="h-auto w-full bg-green-300 p-4 flex flex-col items-center justify-center space-y-4">
      <h3 id="contact-me" className="text-md font-semibold">
        Contact Me
      </h3>
      <Link href="mailto:emanuehl159@gmail.com" className="text-sm">
        emanuehl159@gmail.com
      </Link>
