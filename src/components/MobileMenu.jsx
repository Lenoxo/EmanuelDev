  ...
  return (
    <>
      <nav
        ...
        className={`fixed z-30 flex flex-col transition-all ease-in-out w-full top-14 mt-[0.3rem] p-8 bg-white dark:bg-zinc-900 items-start text-start justify-between font-semibold text-lg ${
