...
export default function MobileMenu({ setShowMobileMenu }) {
  ...
  return (
    <>
      <nav style={navHeight} className="fixed z-30 flex flex-col w-full top-14 mt-[0.3rem] p-8 bg-white dark:bg-zinc-900 items-start text-start justify-between font-semibold text-lg">
